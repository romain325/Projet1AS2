...
namespace prjtS2.FunctLibrary.Tools
{
    ...
    public class CollectionToString : ICollectionToString
    {
        ...
        public string GetSeparator(CollectionToStringType type)
        {
            return type switch
            {
                CollectionToStringType.LineBreak => "\n",
                CollectionToStringType.LineBreakComa => ",\n",
                CollectionToStringType.InLineSpace => " ",
                CollectionToStringType.InLineComa => ", ",
                CollectionToStringType.SlashSlash => "// ",
                CollectionToStringType.None => "",
                CollectionToStringType.Sharp => "#",
                _ => " ",
            };
        }
