...
{
    /// <summary>
    /// Json GEstion of Beer Proposition, For Docs refer to IGestion
    /// </summary>
    public class JsonPropBiere : JsonProduit<PropBiere>
    {
        public override Dictionary<string, PropBiere> Lib => Library.PROP_BIERES;
        ...
        public override void GetDicoAllFromFile()
        {
            ...
            foreach (var item in jsonFile["root"])
            {
                ...
                new PropBiere(item[eltName]["name"].ToString(),
        ...
        public override JObject Pattern(PropBiere elt)
        {
            return new JObject(
                new JProperty(eltName,
                    new JObject(
                        ...
                        new JProperty("others", elt.Others)
                    )
                )
                );
        }
